...
final class UserSubscriptionFixture extends Fixture
{
    public const SUBSCRIPTION_HASH = 'random_hash';

    public function load(ObjectManager $manager): void
    {
        $shopUser = $this->getReference(ShopUserFixture::SHOP_USER_REFERENCE, ShopUser::class);
        $channel = $this->getReference(ChannelFixture::CHANNEL_REFERENCE, Channel::class);

        $userSubscription = new UserSubscription($shopUser, self::SUBSCRIPTION_HASH, []);
