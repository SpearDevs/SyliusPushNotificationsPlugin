...
final class RetailShopUserFixture extends Fixture
{
    public const SHOP_USER_REFERENCE = 'retail_shop_user';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $shopUser->setCustomer(
            $this->getReference(RetailCustomerFixture::CUSTOMER_REFERENCE, Customer::class),
        );
